...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            кожей, гнилыми зубами и в костюме клоуна. Он с ненавистью
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            Ты вбегаешь в оружейную лабораторию и начинаешь
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            видишь пятерых готонов, безуспешно пытающихся управлять
        ...
        if action == "бросить бомбу":
            ...
            print(dedent("""
                ...
                мушке. Ты запрыгиваешь в шлюз и закрываешь дверь
                ударом по кнопке, а затем бластером расплавляешь
                замок, чтобы готоны не смогли открыть её. Теперь
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                Ты запрыгиваешь в капсулу номер {guess} и нажимаешь
                ...
                топливный отсек корабля готонов, и тот тоже
