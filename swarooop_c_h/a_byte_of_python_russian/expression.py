...
x = True
print('57.', not x) # Если x равно True, оператор вернёт False

x = False
y = True
print('61.', x and y) # x and y даёт False, если x равно False, в противном случае возвращает значение y

x = True
y = False
print('65.', x or y) # Если x равно True, в результате получим True, в противном случае получим значение y
