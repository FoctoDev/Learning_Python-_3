...
class SchoolMember(metaclass=ABCMeta):
    '''Представляет любого человек в школе.'''
...
# Класс SchoolMember - абстрактный базовый класс.
# Т.е. он является лишь некой концепцией, не предназначенной
# для использования в качестве реального класса.
